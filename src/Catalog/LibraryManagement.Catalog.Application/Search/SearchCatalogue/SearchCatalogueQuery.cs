...
/// <summary>
/// Searches the catalogue: which records answer to this form?
/// </summary>
...
/// </para>
/// </remarks>
public sealed record SearchCatalogueQuery(string SearchTerm) : IQuery<IReadOnlyList<CatalogueEntryDto>>
{
