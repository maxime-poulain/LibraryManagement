...
/// <summary>
/// Points the Circulation module's store at SQL Server, at this assembly's migrations, and at a history
...
/// </remarks>
public static class CirculationSqlServer
{
    /// <summary>Configures SQL Server for <see cref="CirculationDbContext"/>.</summary>
    ...
    public static DbContextOptionsBuilder UseCirculationSqlServer(
        this DbContextOptionsBuilder options,
        string connectionString)
        => options.UseModuleSqlServer(
            connectionString, CirculationDbContext.Schema, typeof(CirculationSqlServer).Assembly);
    ...
    public static DbContextOptionsBuilder<TContext> UseCirculationSqlServer<TContext>(
