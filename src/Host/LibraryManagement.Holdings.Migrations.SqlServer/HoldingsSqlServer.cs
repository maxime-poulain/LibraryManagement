...
/// <summary>
/// Points the Holdings module's store at SQL Server, at this assembly's migrations, and at a history
...
/// </remarks>
public static class HoldingsSqlServer
{
    /// <summary>Configures SQL Server for <see cref="HoldingsDbContext"/>.</summary>
    ...
    public static DbContextOptionsBuilder UseHoldingsSqlServer(
        this DbContextOptionsBuilder options,
        string connectionString)
        => options.UseModuleSqlServer(
            connectionString, HoldingsDbContext.Schema, typeof(HoldingsSqlServer).Assembly);
    ...
    public static DbContextOptionsBuilder<TContext> UseHoldingsSqlServer<TContext>(
