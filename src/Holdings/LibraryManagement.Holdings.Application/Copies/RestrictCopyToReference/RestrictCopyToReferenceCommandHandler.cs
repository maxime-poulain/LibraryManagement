...
/// <summary>
/// Handles <see cref="RestrictCopyToReferenceCommand"/>.
/// </summary>
/// <param name="copies">The store holding the copy.</param>
public sealed class RestrictCopyToReferenceCommandHandler(ICopyRepository copies)
    : ICommandHandler<RestrictCopyToReferenceCommand, Result>
{
    /// <inheritdoc/>
    public async ValueTask<Result> Handle(
        RestrictCopyToReferenceCommand command,
        CancellationToken cancellationToken)
    {
        ...
        return copy.RestrictToReference();
    }
}
