...
/// <summary>
/// Handles <see cref="SendCopyForRepairCommand"/>.
/// </summary>
/// <param name="copies">The store holding the copy.</param>
public sealed class SendCopyForRepairCommandHandler(ICopyRepository copies)
    : ICommandHandler<SendCopyForRepairCommand, Result>
{
    /// <inheritdoc/>
    public async ValueTask<Result> Handle(
        SendCopyForRepairCommand command,
