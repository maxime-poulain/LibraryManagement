...
/// <summary>
/// Handles <see cref="WithdrawCopyCommand"/>.
/// </summary>
/// <param name="copies">The store holding the copy.</param>
public sealed class WithdrawCopyCommandHandler(ICopyRepository copies)
    : ICommandHandler<WithdrawCopyCommand, Result>
{
    /// <inheritdoc/>
    public async ValueTask<Result> Handle(
        WithdrawCopyCommand command,
