...
/// <summary>
/// Handles <see cref="ReturnCopyFromRepairCommand"/>.
/// </summary>
/// <param name="copies">The store holding the copy.</param>
public sealed class ReturnCopyFromRepairCommandHandler(ICopyRepository copies)
    : ICommandHandler<ReturnCopyFromRepairCommand, Result>
{
    /// <inheritdoc/>
    public async ValueTask<Result> Handle(
        ReturnCopyFromRepairCommand command,
