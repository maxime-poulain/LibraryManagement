...
/// <summary>
/// Handles <see cref="ReleaseCopyForLendingCommand"/>.
/// </summary>
/// <param name="copies">The store holding the copy.</param>
public sealed class ReleaseCopyForLendingCommandHandler(ICopyRepository copies)
    : ICommandHandler<ReleaseCopyForLendingCommand, Result>
{
    /// <inheritdoc/>
    public async ValueTask<Result> Handle(
        ReleaseCopyForLendingCommand command,
