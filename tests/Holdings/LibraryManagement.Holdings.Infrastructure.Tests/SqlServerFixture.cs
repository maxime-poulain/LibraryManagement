...
namespace LibraryManagement.Holdings.Infrastructure.Tests;
...
/// rests on: a schema of its own, beside Catalog's, and a <c>rowversion</c> the engine maintains.
/// </para>
/// <para>
...
/// service container, a local instance. Leave it unset and a container is started, so a fresh clone
/// needs no setup beyond Docker.
/// </para>
/// </remarks>
public sealed class SqlServerFixture : IAsyncLifetime
{
    ...
    private const string DatabaseName = "LibraryManagement_Holdings_Tests";
