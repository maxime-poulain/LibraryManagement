...
public sealed class HangfireDrainTests(SqlServerFixture sqlServer) : IAsyncLifetime
{
    ...
    public async ValueTask InitializeAsync()
    {
        ...
        // Every module, because OutboxJobs is the host's surface and takes one processor per module
        ...
        _provider = CompositionRoot.Services()
            ...
            .AddChargesModule(options => options.UseSqlServer(sqlServer.ConnectionString))
