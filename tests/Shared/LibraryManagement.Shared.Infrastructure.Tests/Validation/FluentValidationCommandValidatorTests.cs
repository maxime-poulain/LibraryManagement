...
public sealed class FluentValidationCommandValidatorTests
{
    ...
    private static FluentValidationCommandValidator ValidatorWith(params Action<IServiceCollection>[] registrations)
    {
        ...
        return new FluentValidationCommandValidator(services.BuildServiceProvider());
    }

    private static FluentValidationCommandValidator WithTheBookValidator()
